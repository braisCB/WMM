...
namespace wmm3D {
    ...
    double GetVal3D(Grid3 &image, Grid3 &u_surface, AugWmm3 &wave, Node3D &neigh, Node3D &fn, Node3D &h, int interp, int mode) {
        ...
        double fti = GetIntegralValue(image, wave_p, neigh, norm(f0), norm(fn), interp, wave.gamma - 1);
    ...
    void augWmm3DIsoSurface3D(Grid3 &image, std::vector<Node3> &initials, Node3D &h,
    ...
    Grid3 augWmm3DIsoSurface3D(Grid3 &image, std::vector<Node3> &initials,
                                      Node3D &h, int interp, int mode, int N, int gamma) {
        Grid3 u_surface = Grid3(MAX_VAL, image.rows, image.cols, image.channels, 1);
        augWmm3DIsoSurface3D(image, initials, h, interp, mode, N, gamma, u_surface);
        return u_surface;
    }
